...
var ClientController = /** @class */ (function () {
    function ClientController(clientServices) {
        this.clientServices = clientServices;
    }
    ClientController.prototype.Register = function (createAdminDto) {
        return __awaiter(this, void 0, void 0, function () {
            var saltOrRounds, password, hash, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(Object.keys(createAdminDto).length == 0)) return [3 /*break*/, 1];
                        return [2 /*return*/, { message: "please enter valide data" }];
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, this.clientServices.Register(data)];
                }
            });
        });
    };
    ...
    ClientController.prototype.Login = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var dbpassword, password, validepassword;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.clientServices.Login(data)];
                    case 1:
                        dbpassword = _a.sent();
    ...
    __decorate([
        ...
        __param(0, (0, common_1.Body)())
    ], ClientController.prototype, "Login");
