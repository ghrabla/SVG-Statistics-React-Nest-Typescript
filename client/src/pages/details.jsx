        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 ">
            <div className="flex justify-center items-center lg:flex-row flex-col gap-8">
                ...
                <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center mt-20">
                    ...
                    <p className=" font-normal text-base leading-6 text-gray-600 mt-7"> Voiture Huv is an urban electric vehicle for the future, built for the demands of everybody in today’s world. With a clean and minimal design, it shows an ease of use that is unique and purposeful. </p>
                    ...
                    <button className="focus:outline-none focus:ring-2 hover:bg-black focus:ring-offset-2 focus:ring-gray-800 font-medium text-base leading-4 text-white bg-gray-800 w-full py-5 lg:mt-12 mt-6 rounded">Add to shopping bag</button>
                </div>
                ...
                <div className=" w-full sm:w-96 md:w-8/12  lg:w-6/12 flex lg:flex-row flex-col lg:gap-8 sm:gap-6 gap-4">
                    <div className=" w-full lg:w-8/12 bg-gray-100 flex justify-center items-center">
                        <img src="https://pininfarina.it/wp-content/uploads/2022/05/NAMX-01.jpg" alt="Wooden Chair Previw" />
                    </div>
                    <div className=" w-full lg:w-4/12 grid lg:grid-cols-1 sm:grid-cols-4 grid-cols-2 gap-6">
                        <div className="bg-gray-100 flex justify-center items-center py-4">
                            <img src="https://pininfarina.it/wp-content/uploads/2022/05/NAMX-02.jpg" alt="Wooden chair - preview 1" />
                        </div>
                        <div className="bg-gray-100 flex justify-center items-center py-4">
                            <img src="https://pininfarina.it/wp-content/uploads/2022/05/NAMX-03.jpg" alt="Wooden chair - preview 2" />
                        </div>
                        <div className="bg-gray-100 flex justify-center items-center py-4">
                            <img src="https://pininfarina.it/wp-content/uploads/2022/05/NAMX-04.jpg" alt="Wooden chair- preview 3" />
                        </div>
                    </div>
                </div>
            </div>
