      ...
      >
        ...
        <option value="park">park</option> 
            ...
            <p className=" font-normal text-base leading-6 text-gray-600 mt-7">
              {' '}
              Voiture Huv is an urban electric vehicle for the future, built for
              the demands of everybody in today’s world. With a clean and
              minimal design, it shows an ease of use that is unique and
              purposeful.{' '}
            </p>
            ...
            <button className="focus:outline-none focus:ring-2 hover:bg-black focus:ring-offset-2 focus:ring-gray-800 font-medium text-base leading-4 text-white bg-gray-800 w-full py-5 lg:mt-12 mt-6 rounded">
              Add to shopping bag
            </button>
          </div>
