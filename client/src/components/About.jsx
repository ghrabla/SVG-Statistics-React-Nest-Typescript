        ...
        <div class="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            <div class="flex flex-col lg:flex-row justify-between gap-8">
                <div class="w-full lg:w-5/12 flex flex-col justify-center">
                    ...
                    <p class="font-normal text-base leading-6 text-gray-600 dark:text-white">Le HUV présente la particularité de proposer des réservoirs à hydrogène interchangeables. Six réservoirs d'hydrogène interchangeables s'ajoutent au réservoir principal et permettent de bénéficier d'une autonomie de 800 kilomètres. Ce système permet d'échanger facilement les six réservoirs amovibles dans une station sans faire le « plein » du réservoir principal, les stations-service pour l'hydrogène étant peu répandues</p>
                </div>
                ...
                <div class="w-full lg:w-8/12 lg:pt-8">
                    <div class="grid md:grid-cols-3 sm:grid-cols-3 lg:gap- shadow-lg rounded-md">
                        <div class="p-4 pb-6 flex justify-center flex-col items-center">
                            ...
                            <p class="font-medium text-xl leading-5 text-gray-800 dark:text-white mt-4">RHRABLA Kamal</p>
                        </div>
                        <div class="p-4 pb-6  flex justify-center flex-col items-center">
                            <img class="md:block hidden" src={process.env.PUBLIC_URL+"assets/nadia.jpg"} alt="" />
                            <p class="font-medium text-xl leading-5 text-gray-800 dark:text-white mt-4">ELHADRI Nadia</p>
                        </div>
                        <div class="p-4 pb-6 flex justify-center flex-col items-center">
                            <img class="md:block hidden" src={process.env.PUBLIC_URL+"assets/Touti.jpg"} alt="" />
                            <p class="font-medium text-xl leading-5 text-gray-800 dark:text-white mt-4">TOUTI Yassine</p>
                        </div>
                    </div>
                </div>
            </div>
