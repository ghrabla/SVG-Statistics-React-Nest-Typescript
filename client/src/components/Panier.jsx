...
const baseURL = "http://localhost:9000/cars/id";
  ...
  if (!product) return null;
    return (
        <>
         {product.map((index)=>(
            <div>
                <div className="flex items-center justify-center py-8" key={index._id}>
                        ...
                        <div className="w-full absolute z-10 right-0 h-full overflow-x-hidden transform translate-x-0 transition ease-in-out duration-700" id="checkout">
                            <div className="flex md:flex-row flex-col justify-end" id="cart">
                                <div className="lg:w-1/2 w-full md:pl-10 pl-4 pr-10 md:pr-4 md:py-12 py-8 bg-white overflow-y-auto overflow-x-hidden h-screen" id="scroll">
                                    ...
                                    <p className="text-5xl font-black leading-10 text-gray-800 pt-3">Namx</p>
                                    <div className="md:flex items-center mt-14 py-8 border-t border-gray-200">
                                        <div className="w-1/4">
                                            <img src="'http://localhost/fill-rouge/backend/images/' + {index.image}" alt className="w-full h-full object-center object-cover" />
                                        </div>
                                        <div className="md:pl-3 md:w-3/4">
                                            <p className="text-xs leading-3 text-gray-800 md:pt-0 pt-4">{index.name}</p>
                                            <div className="flex items-center justify-between w-full pt-1">
                                                <p className="text-base font-black leading-none text-gray-800">North wolf Namx</p>
                                            ...
                                            <p className="text-xs leading-3 text-gray-600 py-4">{index.color}</p>
                                            ...
                                            <div className="flex items-center justify-between pt-5 pr-6">
                                                ...
                                                <p className="text-base font-black leading-none text-gray-800">${index.price}</p>
                                            </div>
                                        </div>
                                    </div>
